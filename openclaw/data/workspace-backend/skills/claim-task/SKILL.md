...
- The branch name.
- Pointers to artifacts to read in SPIKE: `docs/architecture/api/<service>/openapi.yaml`, `docs/architecture/data-model.md`, relevant ADRs, `docs/architecture/protocols.md`.
