...
3. If sort fails, identify the cycle, break it (usually by removing one direction, or merging the two Stories), document the change in the Epic's Open Questions, and re-run.
